...
After downloading the data from the data source, we can read the two files into two data frames.  
```{r}
...
```
We get rid of some columns that do not contribute much to the accelerometer measurements.  
```{r}
